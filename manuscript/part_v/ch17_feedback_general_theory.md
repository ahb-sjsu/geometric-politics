...
> *"Every domain book must answer: what does this domain teach us that we could not learn from the general theory alone?"*
> — Geometric Series, internal methodology note

---

> **RUNNING EXAMPLE — DISTRICT 7**
>
> *District 7 has been our laboratory for seventeen chapters: a six-dimensional electorate forced through one-dimensional institutions, its preferences contracted to scalars, its manifold structure systematically destroyed by voting systems, campaigns, media, and redistricting. We have diagnosed the destruction, measured it with the Political Bond Index, and proposed partial remedies — RCV, deliberation, manifold-aware redistricting.*
>
> *Now we step back and ask: what has District 7 taught the Geometric Series? What features of the political domain are unique — lessons that could not have been learned from ethics, economics, law, cognition, communication, or medicine alone? This chapter identifies three: the discrete-continuous tension, the $D_4$ of political symmetry, and the geometry of collective choice.*
...
| Domain | Input Manifold | Output Space | Contraction Severity |
|---|---|---|---|
| Economics | 9D decision manifold | Continuous prices, quantities | Moderate |
| Law | Judicial manifold | Ordinal sentences, binary verdicts | High |
| Medicine | Clinical manifold | Treatment spectra, ordinal triage | Moderate |
| Cognition | Cognitive manifold | Scalar test scores | High |
| Communication | Semantic manifold | Scalar metrics (BLEU, etc.) | High |
| **Politics** | **6D preference manifold** | **Binary votes, single winners** | **Extreme** |
