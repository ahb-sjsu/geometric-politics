...
> *"The best argument against democracy is a five-minute conversation with the average voter. The best argument for democracy is everything else."*
...
>
> *Before District 7 was a congressional district, it was farmland, and before that it was Lenape territory, and before that it was a landscape without political boundaries at all. The modern district emerged from a sequence of institutional choices — each one a decision about how to contract the political manifold to a manageable output. In this chapter, we trace the parallel history: the evolution of democratic institutions across 2,500 years, read geometrically as a series of decisions about dimensional compression.*
>
> *District 7 was first drawn after the 1870 census, as a multi-member district sending three representatives to the state legislature. The multi-member format preserved some dimensional structure: voters could split their three votes across candidates who represented different dimensions of their preferences. In 1914, the state adopted single-member districts under the progressive reform movement. District 7 shrank to one representative, elected by plurality. The dimensional compression was complete: a multi-dimensional electorate, contracted to a single winner, chosen by a one-dimensional voting system.*
>
> *Every institutional reform since has been a renegotiation of the same geometric question: how much of the manifold does the voting system preserve?*
...
### Duverger's Law as Geometric Inevitability

The French political scientist Maurice Duverger observed in 1954 that plurality voting systems tend to produce two-party systems, while proportional representation systems tend to produce multi-party systems. This observation — Duverger's Law — is usually explained by strategic voting: in a plurality system, voters abandon third parties to avoid "wasting" their vote, and the resulting consolidation leaves two dominant parties.

The geometric explanation is more fundamental. A plurality voting system is a contraction that selects the candidate with the most first-choice votes. The contraction is one-dimensional: it projects the manifold onto the "most popular" axis and declares the projection's maximum the winner. In such a system, two parties suffice to span the one-dimensional output space. A third party can only fragment the vote on the projection axis, producing the spoiler effect. Duverger's Law is not a sociological regularity — it is a geometric consequence of the voting system's dimensionality.

Proportional representation, by contrast, maps the manifold onto a higher-dimensional output space — a legislature with many seats, allocated proportionally to party vote share. The higher-dimensional output space permits more parties to survive because there is room on the output manifold for them. A five-party system projects the manifold onto five points rather than two, preserving more dimensional structure.

The choice between plurality and proportional representation is, geometrically, a choice about how much dimensional compression to impose. Countries that chose plurality (UK, US, Canada, India) accepted severe compression in exchange for governmental stability and clear mandates. Countries that chose proportional representation (Germany, the Netherlands, Scandinavia) accepted coalition complexity in exchange for dimensional fidelity. Neither choice is objectively superior — each trades off different values. But the trade-off is geometric, and understanding it geometrically clarifies what each system gains and loses.
